          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a 
                ...
                className="bg-library-white text-library-teal px-6 py-3 rounded-full font-semibold hover:bg-library-white/90 transition-colors inline-block">
              ...
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="border-2 border-library-white text-library-white px-6 py-3 rounded-full font-semibold hover:bg-library-white hover:text-library-teal transition-all inline-block">
